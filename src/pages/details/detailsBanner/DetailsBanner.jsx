...
const DetailsBanner = ({ video, crew }) => {
    ...
    const writer = crew?.filter((dir) => dir.job === 'Screenplay' || dir.job === 'Story' || dir.job === 'Writer')
    return (
                                    ...
                                    <div className="info">
                                        ...
                                        }
                                        {
                                            !!data?.release_date && <div className="infoItem">
                                                ...
                                                <span className="text">
                                                    {dayjs(data?.release_date).format(' MMM, ddd YYYY')}
                                                </span>
                                            </div>
                                        }
                                        {
